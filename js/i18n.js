const I18N = {
    en: {
        ...
        subs_arabic: "Arabic (auto)",
        subs_arabic_on: "Arabic subtitles on",
        subs_arabic_error: "No Arabic subtitle found for this title",
        prev_episode: "Previous episode",
        next_episode: "Next episode",
        more_like: "More like this",
        stream_failed: "Stream not playing — switching source",
        retrying: "retrying…",
        subs_sync: "Sync",
        subs_auto: "Auto",
        subs_reset: "Reset offset",
        subs_synced: "Subtitle synced",
        subs_sync_none: "Select a subtitle first",
        subs_auto_none: "No auto-sync needed",
        subs_cal: "Calibrate",
        subs_cal_p1: "Point 1 set — press Calibrate at a later scene",
        subs_cal_p2: "Calibrated",
        subs_cal_none: "No subtitle at the current time",
        subs_cal_close: "Points too close — try again",
    ...
    ar: {
        ...
        subs_arabic: "العربية",
        subs_arabic_on: "تفعيل الترجمة العربية",
        subs_arabic_error: "لا توجد ترجمة عربية لهذا العمل",
        prev_episode: "الحلقة السابقة",
        next_episode: "الحلقة التالية",
        more_like: "أعمال مشابهة",
        stream_failed: "المصدر لا يعمل — جارٍ التبديل تلقائيًا",
        retrying: "إعادة المحاولة…",
        subs_sync: "ضبط التوقيت",
        subs_auto: "تلقائي",
        subs_reset: "إعادة الضبط",
        subs_synced: "تم ضبط الترجمة",
        subs_sync_none: "اختر ترجمة أولًا",
        subs_auto_none: "لا حاجة لضبط تلقائي",
        subs_cal: "معايرة",
        subs_cal_p1: "تم ضبط النقطة 1 — اضغط معايرة عند مشهد لاحق",
        subs_cal_p2: "تمت المعايرة",
        subs_cal_none: "لا توجد ترجمة في هذه اللحظة",
        subs_cal_close: "النقطتان متقاربتان — أعد المحاولة",
